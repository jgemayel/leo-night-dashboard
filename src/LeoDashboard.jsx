    ...
    <div style={{fontFamily:"'DM Sans',-apple-system,'Segoe UI',sans-serif",background:"#0b0b13",color:"rgba(255,255,255,0.85)",minHeight:"100vh",maxWidth:640,margin:"0 auto"}}>
      ...
      <div style={{padding:"28px 20px 20px",background:"linear-gradient(180deg, rgba(99,102,241,0.07) 0%, transparent 100%)"}}>
        <div style={{display:"flex",alignItems:"center",gap:12}}>
          ...
          <div><h1 style={{fontSize:20,fontWeight:800,margin:0,letterSpacing:"-0.02em",color:"#e0e7ff"}}>Leo's Night Report</h1><p style={{fontSize:12,color:"rgba(255,255,255,0.3)",margin:"3px 0 0",fontWeight:500}}>Jan 10 - Mar 21, 2026 · 63 nights · 7 PM - 7 AM</p><p style={{fontSize:11,color:"rgba(255,255,255,0.22)",margin:"2px 0 0",fontWeight:500}}>Born Nov 6, 2025 · Age 9 weeks (2mo) to 19.5 weeks (4.5mo)</p></div>
        </div>
      </div>
